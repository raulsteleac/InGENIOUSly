...
void *udpserver()
{
	...
	printf("\nAstept client:\n");
		...
		buffer[3]=buffer[3]&0|3;
	  buffer[3]=buffer[3]<<4|4;
		buffer[4]=buffer[3]|1;
		buffer[4]=buffer[3]<<4|2;
		buffer[5]=buffer[5]|2;
		...
		buffer[8]=buffer[8]|1;
		buffer[8]=buffer[8]<<4|2;
		buffer[9]=buffer[9]|2;
		buffer[9]=buffer[9]<<4|3;
		buffer[10]=buffer[10]|3;
		buffer[11]=buffer[11]|3;
		buffer[11]=buffer[11]<<4|4;
		buffer[12]=buffer[12]|1;
		buffer[12]=buffer[12]<<4|2;
	buffer[13]=buffer[13]|2;
		buffer[13]=buffer[13]<<4|3;
		buffer[14]=buffer[14]|3;
		buffer[14]=buffer[14]<<4|4;
		buffer[15]=buffer[15]|5;
		buffer[15]=buffer[15]<<4|1;
		buffer[16]='\0';
