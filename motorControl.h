...
void readLineSensors()
{
  ...
  else if((lineSensor[0]== 0 )&&(lineSensor[1]== 0 )&&(lineSensor[2]== 0 )&&(lineSensor[3]== 0 )&&(lineSensor[4]== 0 ))  {mode = FOLLOWING_LINE; error = 0;}
  ...
  *reset=0;
    ...
    { 
       ...
       case STOPPED:
        ...
        break;
        case FOLLOWING_LINE:
     	   decisionDecode( conti, ledRight,ledLeft, flagMiddle,reset);
		    readLineSensors();
            calculatePID();
            motorPIDcontrol(PIDSPD);
